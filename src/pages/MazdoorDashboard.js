  ...
  return (
    <div className="py-8 ">
      ...
      <div className="flex" >
          ...
          <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            >
             ...
             <img
              ...
              <span className="text-white text-sm">Mazdoor</span>
            </Link>
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                  <FaUser className="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-white group-hover:text-white dark:group-hover:text-white"/>
              ...
              <li>
                ...
                >
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap">Chat Hub</span>
        ...
        <div className='flex-grow p-4 h-screen border-2 rounded-sm' >
